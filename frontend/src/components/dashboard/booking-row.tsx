...
export function BookingRow({
  ...
  const formattedDate = isHotel
      ...
      : formatDate(booking.departureTime ?? booking.createdAt, locale);
      ...
      >
        ...
        <div className="flex items-center gap-3.5 min-w-0">
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <div className="text-[11px] text-muted-foreground/80 font-medium flex flex-wrap items-center gap-1.5">
              <span>{formattedDate}</span>

              {showContact && (
                  <>
                    <span className="text-muted-foreground/40">•</span>
                    <span className="truncate text-primary/80 font-semibold">

...
import { useCreateVehicleMutation } from "@/hooks/use-partner-queries";
...
export default function NewVehiclePage() {
    ...
    const createVehicleMutation = useCreateVehicleMutation(partnerId);

    const [form, setForm] = useState<VehicleRegistrationRequest>({
        brand: "",
        model: "",
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            await createVehicleMutation.mutateAsync(form);
        ...
        <div className="mx-auto max-w-3xl space-y-8 py-6 px-4">
            ...
            <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                    Renseignez les informations de votre véhicule pour le proposer à la location.
                </p>
            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Select
                                    value={form.category}
                                    onValueChange={(val) =>
                                        setForm((prev) => ({ ...prev, category: val as VehicleCategory }))
                                    }
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(val) =>
                                        setForm((prev) => ({ ...prev, transmission: val as Transmission }))
                                    }
                                >
                        ...
                        <div className="flex items-center justify-between rounded-xl border p-4">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) =>
                                    setForm((prev) => ({ ...prev, airConditioning: checked }))
                                }
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <PickupLocationsInput
                                ...
                                onChange={(pickupLocations) => setForm((prev) => ({ ...prev, pickupLocations }))}
                            />
                        </div>

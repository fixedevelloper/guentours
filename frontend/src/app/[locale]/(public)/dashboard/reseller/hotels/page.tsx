...
export default function ResellerHotelsPage() {
    return (
        <Suspense
            fallback={
        ...
        >
            <ResellerHotelsPageContent />
        </Suspense>
    );
}

function ResellerHotelsPageContent() {
    ...
    function handleSearch(next: HotelSearchParams) {
        ...
        router.push(`/dashboard/reseller/hotels?${hotelSearchParamsToQuery(next)}`);
    }
    ...
    return (
        <div className="mx-auto max-w-7xl px-4 py-8 space-y-8 pb-24 sm:pb-12">
            ...
            {query.isLoading ? (
                ...
                <>
                    ...
                    {/* GRILLE PRINCIPALE TRIPLE COLONNES */}
                        ...
                        <main className="space-y-4">
                            ...
                            <div className="space-y-4">
                                <HotelResultsList
                                    ...
                                    hoveredKey={hoveredKey}
                                    onHoverChange={setHoveredKey} isReseller={true}                                />
                            </div>

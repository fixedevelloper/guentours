...
import { CarRentalForm } from "@/components/search/car-rental-form";

// Catégories de véhicules avec leurs détails
const CATEGORIES = [
    {
        id: "economy",
        icon: Car,
        titleKey: "catEconomyTitle",
        descKey: "catEconomyDesc",
        seats: "4-5",
        luggage: "2",
        tagKey: "catPopular",
    },
    ...
    },
    {
        id: "luxury",
        icon: Sparkles,
        titleKey: "catLuxuryTitle",
        descKey: "catLuxuryDesc",
        seats: "5",
        luggage: "3",
        tagKey: "catPremium",
    },
...
export default function CarRentalPage() {
    ...
    return (
        <main className="min-h-screen bg-background pb-16">
                ...
                <div className="container max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto mt-10 pt-6 border-t border-border/50 text-xs sm:text-sm">
                        <div className="flex items-center gap-2.5 text-muted-foreground">
                            ...
                            <span className="font-medium">{t("perkFreeCancellation")}</span>
                        </div>
                        <div className="flex items-center gap-2.5 text-muted-foreground">
                            <CreditCard className="size-5 text-primary shrink-0" />
                            <span className="font-medium">{t("perkNoHiddenFees")}</span>
                        </div>
                        <div className="flex items-center gap-2.5 text-muted-foreground">
                        ...
                        <div className="flex items-center gap-2.5 text-muted-foreground">
                            ...
                            <span className="font-medium">{t("perkVerifiedPartners")}</span>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                        {STEPS.map((step) => {
                            ...
                            return (
                                <div
                                    key={step.number}
                                    className="relative flex flex-col items-center text-center p-6 rounded-3xl bg-background border border-border/60 shadow-sm"
                                >
            ...
            {/* 4. BANNIÈRE APPEL À L'ACTION (DEVENIR PARTERNAIRE / DEVENIR HÔTE) */}
            <section className="py-16 container max-w-7xl mx-auto px-4 sm:px-6">

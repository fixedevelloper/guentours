package com.guentours.partners.domain;
...
public class Partner {
    ...
    private Integer fleetOrUnitsCount;
    ...
    // Partner.java — ajouter cette méthode (pas de setters publics par champ, cohérent avec approve()/reject())

    public void updateProfile(String companyName, String phone, String city, String country, String description) {
